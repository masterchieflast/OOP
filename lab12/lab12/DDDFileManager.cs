...
namespace lab12
{
    public class DDDFileManager
    {
        public static void GetAllDirsAndFilesOfDisk(string diskName)
        {
            ...
            {
                var dir = new DirectoryInfo(@"D:\study\sem3\OOP\lab12");
        ...
        public static void GetAllFilesWithExtension(string dirPath, string extension)
        {
            ...
            if (directory.Exists)
            {
                var temp = new DirectoryInfo(@"D:\study\sem3\OOP\lab12");
        ...
        {
            const string zipName = @"D:\study\sem3\OOP\lab12\DDDInspect\DDDFiles.zip";
            if (new DirectoryInfo(@"D:\study\sem3\OOP\lab12\DDDInspect").GetFiles("*.zip").Length == 0)
            {
